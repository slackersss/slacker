...
for xd in range(10000):
	...
	d='SM-G532G Build/MMB29T)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91'
	...
	g='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0'
